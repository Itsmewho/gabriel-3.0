        ...
        if self.open_test_trades:
            ...
            if now > self.last_modification_time + timedelta(seconds=10):
                ...
                for ticket in self.dwx.open_orders.keys():
                    self.dwx.close_order(ticket, lots=0.1)  # type: ignore
...
MT4_files_dir = "C:/Users/Itsme/AppData/Roaming/MetaQuotes/Terminal/73B7A2420D6397DFF9014A20F1201F97/MQL5/Files/"
